...
const columns: TableColumnsType<DataType> = [
  {
    ...
    render: (_, { name: firstname }) => (
      <Avatar size={24} src={`https://ui-avatars.com/api/?name=${firstname}`} />
    ),
  },
  {
    title: "Estudiante",
  ...
  },
  {
    title: "Carrera",
    dataIndex: "career",
    filters: generateFilters(datos, "career"),
  ...
  },
  {
    title: "Estado",
    dataIndex: "state",
    filters: generateFilters(datos, "state"),
    onFilter: (value, record) => record.state === value,
    render: (state) => {
      const color =
        state === "Proceso" ? "blue" : state === "Retirado" ? "red" : "green";
      return (
